...
class TestCaseTeacher(object):
    ...
    def RunTest(self): 
        ...
        TC_createTeacher = self.my_sqlconnector.create_teacher(teacher_LName, teacher_FName, teacher_Years, teacher_Pay, teacher_Rating)
        ...
        string_correct_json = "{{'id': {idnum}, 'lastName': 'Teacher', 'firstName': 'Nancy', 'yearsEmployeed': 8, 'pay': 77000, 'rating': 3.7}}".format(idnum = TC_createTeacher.newId)
